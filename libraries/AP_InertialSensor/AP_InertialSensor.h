...
public:
    ...
    virtual void calibrate_accel( void (*flash_leds_cb)(bool on) = NULL);
...
protected:
    ...
    virtual uint16_t  _init_sensor() = 0;
    ...
    bool _calibrate_accel( Vector3f accel_sample[6],
                           Vector3f& accel_offsets,
                           Vector3f& accel_scale);
    void _calibrate_update_matrices( float dS[6],
                                     float JS[6][6],
                                     float beta[6],
                                     float data[3]);
    void _calibrate_reset_matrices(float dS[6], float JS[6][6]);
    void _calibrate_find_delta( float dS[6],
                                float JS[6][6],
                                float delta[6]);
